package com.bytetobyte.xwallet.ui.main.view;
...
import com.bytetobyte.xwallet.ui.main.TutorialAnim;
...
public class MainActivityView implements MainViewContract {
  ...
  //  public static final int STOP_BOOM_INDEX = 1;
    public static final int BACKUP_BOOM_INDEX = 1;
    public static final int RECOVER_BOOM_INDEX = 2;
    public static final int SEND_BOOM_INDEX = 3;
    public static final int RECEIVE_BOOM_INDEX = 4;
    ...
    private void initCircleMenuBoom() {
        int[] boomsButtons = { R.drawable.ic_check_normal_light ,R.drawable.ic_backup, R.drawable.ic_recover_wallet , R.drawable.ic_send, R.drawable.ic_receive};
        String [] btnsText = { "Sync", "Backup", "Recover", "Send", "Receive" };
